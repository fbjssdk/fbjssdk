...
var ConnectBar = Element.extend({
  ...
  _renderConnectBar: __w(function(/*object*/ info) {__t([info, 'object', 'info']);
    ...
    DOM.html(bar, format(
      ...
      Intl.tx._("Ahoj {firstName}. Str\u00e1nky \u003Cstrong>{siteName}\u003C\/strong> vyu\u017e\u00edvaj\u00ed Facebook pro p\u0159izp\u016fsoben\u00ed va\u0161\u00ed pr\u00e1ce s webem.", {
        firstName: escapeHTML(info.first_name),
        siteName: escapeHTML(info.site_name)
      }),
      Intl.tx._("Dal\u0161\u00ed informace"),
      info.profile_url,
