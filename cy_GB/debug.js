...
var ConnectBar = Element.extend({
  ...
  _renderConnectBar: __w(function(/*object*/ info) {__t([info, 'object', 'info']);
    ...
    DOM.html(bar, format(
      ...
      Intl.tx._("Helo {firstName}. Mae \u003Cstrong>{siteName}\u003C\/strong> yn defnyddio Facebook i wneud eich profiad yn fwy personol.", {
