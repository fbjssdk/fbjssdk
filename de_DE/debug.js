  ...
  _createMobileLoader: __w(function() /*DOMElement*/ {return __t([function() {
    ...
    var chrome = UserAgent.nativeApp()
      ...
      : ('<table>' +
        ...
        '        <div>' + Intl.tx._("Wird geladen ...") + '</div>' +
        '      </td>' +
...
var ConnectBar = Element.extend({
  ...
  _renderConnectBar: __w(function(/*object*/ info) {__t([info, 'object', 'info']);
    ...
    DOM.html(bar, format(
      ...
      Intl.tx._("Hallo {firstName}. \u003Cstrong>{siteName}\u003C\/strong> verwendet Facebook, um dein Erlebnis zu personalisieren.", {
...
} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"1191584","message":"'+e.message+'"}}');}