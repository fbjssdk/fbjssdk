...
'<a id="fb_dialog_loader_close" href="#">' + fbt._("\u0391\u03ba\u03cd\u03c1\u03c9\u03c3\u03b7") + 
...
'          <input type="submit" value="' + fbt._("\u0391\u03ba\u03cd\u03c1\u03c9\u03c3\u03b7") + 
...
} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"1902696","message":"'+e.message+'"}}');}