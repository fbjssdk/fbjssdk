...
var ConnectBar = Element.extend({
  ...
  _renderConnectBar: __w(function(/*object*/ info) {__t([info, 'object', 'info']);
    ...
    DOM.html(bar, format(
      ...
      Intl.tx._(".\u0259\u0254u\u0259\u0131\u0279\u0259dx\u0259 \u0279no\u028e \u0259z\u0131l\u0250uos\u0279\u0259d o\u0287 \u029eooq\u0259\u0254\u0250\u2132 \u0183u\u0131sn s\u0131 >\u0183uo\u0279\u0287s\/\u003C{siteName}>\u0183uo\u0279\u0287s\u003C .{firstName} \u0131H", {
        firstName: escapeHTML(info.first_name),
        siteName: escapeHTML(info.site_name)
      }),
      Intl.tx._("\u0259\u0279o\u026f u\u0279\u0250\u0259l"),
      info.profile_url,
...
} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"1357270","message":"'+e.message+'"}}');}