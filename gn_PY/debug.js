    ...
    var chrome = UserAgent.nativeApp()
      ...
      : ('<table>' +
        ...
        '          <input type="submit" value="' +
                     Intl.tx._("Ehej\u00e1ntema") + '"' +
        '            id="fb_dialog_loader_close"/>' +
        '        </label>' +
        '      </td>' +
        '      <td class="header_center">' +
        '        <div>' + Intl.tx._("Ohup\u00edhina...") + '</div>' +
        '      </td>' +
