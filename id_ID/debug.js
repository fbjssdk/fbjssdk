...
var ConnectBar = Element.extend({
  ...
  _renderConnectBar: __w(function(/*object*/ info) {__t([info, 'object', 'info']);
    ...
    DOM.html(bar, format(
      ...
      Intl.tx._("Hai {firstName}. \u003Cstrong>{siteName}\u003C\/strong> menggunakan Facebook untuk mempersonalisasi pengalaman Anda.", {
        firstName: escapeHTML(info.first_name),
        siteName: escapeHTML(info.site_name)
      }),
      Intl.tx._("Pelajari Selengkapnya"),
      info.profile_url,
