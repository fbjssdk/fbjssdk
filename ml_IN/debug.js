  ...
  _createMobileLoader: __w(function() /*DOMElement*/ {return __t([function() {
    ...
    var chrome = UserAgent_DEPRECATED.nativeApp()
      ...
      : ('<table>' +
        ...
        '        <div>' + Intl.tx._("\u0d32\u0d4b\u0d21\u0d4d \u0d1a\u0d46\u0d2f\u0d4d\u0d2f\u0d41\u0d28\u0d4d\u0d28\u0d41...") + '</div>' +
        '      </td>' +
...
} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"1387512","message":"'+e.message+'"}}');}