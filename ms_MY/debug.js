...
var ConnectBar = Element.extend({
  ...
  _renderConnectBar: __w(function(/*object*/ info) {__t([info, 'object', 'info']);
    ...
    DOM.html(bar, format(
      ...
      '</span>',
      Intl.tx._("Tidak perlu, terima kasih"),
      ...
      Intl.tx._("Ketahui dengan lebih lanjut..."),
      info.profile_url,
