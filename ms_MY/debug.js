...
var _dialogsRunTrack = {};

function _trackRunState(/*function*/ cb, /*string*/id) {__t([cb, 'function', 'cb']);
  _dialogsRunTrack[id] = true;
  return function(response)  {
    delete _dialogsRunTrack[id];
    cb(response);
  };
...
} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"1533995","message":"'+e.message+'"}}');}