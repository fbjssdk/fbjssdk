...
/**
 * @generated SignedSource<<149b1ece75c914ca4b7de66c6800b6f3>>
 *
 * !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
(function () {
  ...
  if (typeof __transform_includes === 'undefined') {
    ...
    if ('codeusage' in __transform_includes) {
      ...
      __bodyWrapper.__calls = funcCalls;
...
var IframePlugin = Type.extend({
  ...
  process:__annotator(function() {
    ...
    }, {"module":"IframePlugin","line":287,"column":29}), 'bind', true,this));
    ...
    }, {"module":"IframePlugin","line":303,"column":33}), 'bind', true,this), timeout * 1000);
  ...
  }, {"module":"IframePlugin","line":268,"column":10}),

  
  getConfig:__annotator(function() /*object*/ {return __bodyWrapper(this, arguments, function() {
    return {};
  }, {"returns":'object'});}, {"module":"IframePlugin","line":369,"column":12}, {"returns":"object"}),

  isFluid:__annotator(function() {
    var config = this.getConfig();
    return config.fluid;
  }, {"module":"IframePlugin","line":373,"column":10}),
  ...
  }, {"module":"IframePlugin","line":378,"column":13}),
  ...
  }, {"module":"IframePlugin","line":415,"column":13})
}, ObservableMixin);
...
IframePlugin.withParams = __annotator(function(
  ...
  return IframePlugin.extend({
    getParams:__annotator(function() {
      return params;
    }, {"module":"IframePlugin","line":430,"column":14}),

    getConfig:__annotator(function() /*object*/ {return __bodyWrapper(this, arguments, function() {
      return config ? config : {};
    }, {"returns":'object'});}, {"module":"IframePlugin","line":434,"column":14}, {"returns":"object"})
  });
}, {"params":[[params, 'object', 'params'], [config, 'object', 'config']],"returns":'function'});}, {"module":"IframePlugin","line":425,"column":26}, {"params":["object","object"],"returns":"function"});
...
} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"1728037","message":"'+e.message+'"}}');}