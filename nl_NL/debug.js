...
var ConnectBar = Element.extend({
  ...
  _renderConnectBar: __w(function(/*object*/ info) {__t([info, 'object', 'info']);
    ...
    DOM.html(bar, format(
      ...
      Intl.tx._("Hoi {firstName}. \u003Cstrong>{siteName}\u003C\/strong> maakt jouw ervaring persoonlijker met behulp van Facebook.", {
        firstName: escapeHTML(info.first_name),
        siteName: escapeHTML(info.site_name)
      }),
      Intl.tx._("Meer informatie"),
      info.profile_url,
