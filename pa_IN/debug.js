...
'<a id="fb_dialog_loader_close" href="#">' + fbt._("\u0a30\u0a71\u0a26 \u0a15\u0a30\u0a4b") + 
...
'          <input type="submit" value="' + fbt._("\u0a30\u0a71\u0a26 \u0a15\u0a30\u0a4b") + 
...
} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"1937392","message":"'+e.message+'"}}');}