  ...
  _createMobileLoader: __w(function() /*DOMElement*/ {return __t([function() {
    ...
    var chrome = UserAgent.nativeApp()
      ...
      : ('<table>' +
        ...
        '        <div>' + Intl.tx._("\u0a32\u0a4b\u0a21 \u0a15\u0a40\u0a24\u0a3e \u0a1c\u0a3e \u0a30\u0a3f\u0a39\u0a3e \u0a39\u0a48...") + '</div>' +
        '      </td>' +
...
} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"1246758","message":"'+e.message+'"}}');}