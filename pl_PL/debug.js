...
var ConnectBar = Element.extend({
  ...
  _renderConnectBar: __w(function(/*object*/ info) {__t([info, 'object', 'info']);
    ...
    DOM.html(bar, format(
      ...
      Intl.tx._("Witaj {firstName}! \u003Cstrong>{siteName}\u003C\/strong> u\u017cywa Facebooka, aby spersonalizowa\u0107 funkcje, z kt\u00f3rych korzystasz.", {
        firstName: escapeHTML(info.first_name),
        siteName: escapeHTML(info.site_name)
      }),
      Intl.tx._("Dowiedz si\u0119 wi\u0119cej"),
      info.profile_url,
...
} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"1257045","message":"'+e.message+'"}}');}