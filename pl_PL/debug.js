...
'<a id="fb_dialog_loader_close" href="#">' + fbt._("Anuluj") + 
...
'          <input type="submit" value="' + fbt._("Anuluj") + 
...
} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"1927278","message":"'+e.message+'"}}');}