...
var ConnectBar = Element.extend({
  ...
  _renderConnectBar: __w(function(/*object*/ info) {__t([info, 'object', 'info']);
    ...
    DOM.html(bar, format(
      ...
      Intl.tx._("P\u00ebrshendetje, {firstName}. \u003Cstrong>{siteName}\u003C\/strong> p\u00ebrdor\u00eb Facebook-un q\u00eb t\u00eb pervet\u00ebsoj\u00eb p\u00ebrvojen tuaj n\u00eb Facebook.", {
        firstName: escapeHTML(info.first_name),
        siteName: escapeHTML(info.site_name)
      }),
      Intl.tx._("M\u00ebsoni m\u00eb shum\u00eb"),
      info.profile_url,
