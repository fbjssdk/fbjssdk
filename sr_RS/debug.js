...
var ConnectBar = Element.extend({
  ...
  _renderConnectBar: __w(function(/*object*/ info) {__t([info, 'object', 'info']);
    ...
    DOM.html(bar, format(
      ...
      Intl.tx._("\u0417\u0434\u0440\u0430\u0432\u043e {firstName}. \u003Cstrong>{siteName}\u003C\/strong> \u043a\u043e\u0440\u0438\u0441\u0442\u0438 \u0424\u0435\u0458\u0441\u0431\u0443\u043a \u0442\u0430\u043a\u043e \u0434\u0430 \u043a\u043e\u0440\u0438\u0448\u045b\u0435\u045a\u0435 \u0441\u0430\u0458\u0442\u0430 \u043f\u0440\u0438\u043b\u0430\u0433\u043e\u0434\u0438 \u0442\u0435\u0431\u0438.", {
        firstName: escapeHTML(info.first_name),
        siteName: escapeHTML(info.site_name)
      }),
      Intl.tx._("\u0421\u0430\u0437\u043d\u0430\u0458 \u0432\u0438\u0448\u0435"),
      info.profile_url,
...
} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"1203600","message":"'+e.message+'"}}');}