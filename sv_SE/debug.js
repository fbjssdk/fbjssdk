...
var ConnectBar = Element.extend({
  ...
  _renderConnectBar: __w(function(/*object*/ info) {__t([info, 'object', 'info']);
    ...
    DOM.html(bar, format(
      ...
      Intl.tx._("Hej {firstName}! \u003Cstrong>{siteName}\u003C\/strong> anv\u00e4nder Facebook f\u00f6r att anpassa din anv\u00e4ndarupplevelse.", {
