    ...
    var chrome = UserAgent.nativeApp()
      ...
      : ('<table>' +
        ...
        '          <input type="submit" value="' +
                     Intl.tx._("\u0b87\u0bb0\u0ba4\u0bcd\u0ba4\u0bc1\u0b9a\u0bcd\u0b9a\u0bc6\u0baf\u0bcd\u0b95") + '"' +
        '            id="fb_dialog_loader_close"/>' +
        '        </label>' +
        '      </td>' +
        '      <td class="header_center">' +
        '        <div>' + Intl.tx._("\u0b8f\u0bb1\u0bcd\u0bb1\u0baa\u0bcd\u0baa\u0b9f\u0bc1\u0b95\u0bbf\u0ba9\u0bcd\u0bb1\u0ba4\u0bc1...") + '</div>' +
        '      </td>' +
...
var ConnectBar = Element.extend({
  ...
  _renderConnectBar: __w(function(/*object*/ info) {__t([info, 'object', 'info']);
    ...
    DOM.html(bar, format(
      ...
      Intl.tx._("\u0bae\u0bc7\u0bb2\u0bc1\u0bae\u0bcd \u0ba4\u0bc6\u0bb0\u0bbf\u0ba8\u0bcd\u0ba4\u0bc1\u0b95\u0bca\u0bb3\u0bcd\u0bb3."),
      info.profile_url,
...
} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"1257260","message":"'+e.message+'"}}');}