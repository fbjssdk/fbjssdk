...
var ConnectBar = Element.extend({
  ...
  _renderConnectBar: __w(function(/*object*/ info) {__t([info, 'object', 'info']);
    ...
    DOM.html(bar, format(
      ...
      Intl.tx._("Xin ch\u00e0o {firstName}. \u003Cstrong>{siteName}\u003C\/strong> hi\u1ec7n \u0111ang s\u1eed d\u1ee5ng Facebook \u0111\u1ec3 c\u00e1 nh\u00e2n h\u00f3a tr\u1ea3i nghi\u1ec7m c\u1ee7a b\u1ea1n.", {
        firstName: escapeHTML(info.first_name),
        siteName: escapeHTML(info.site_name)
      }),
      Intl.tx._("T\u00ecm hi\u1ec3u Th\u00eam"),
      info.profile_url,
