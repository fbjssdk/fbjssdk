...
'<a id="fb_dialog_loader_close" href="#">' + fbt._("\u53d6\u6d88") + 
...
'          <input type="submit" value="' + fbt._("\u53d6\u6d88") + 
...
} catch (e) {new Image().src="https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"1914602","message":"'+e.message+'"}}');}